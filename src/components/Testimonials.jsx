  ...
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col relative}`}>
      ...
      <div className='w-full flex justify-between items-center
       md:flex-row flex-col sm:mb-16 mb-6 relative z-[5]'>
        <h1 className={styles.heading2}>What People are <br className='sm:block hidden' /> 
        saying about us</h1>
        <div className='w-full md:mt-0 mt-6'>
          <p className={`${styles.paragraph} text-left max-w[470px]`}>Everything you need to accept card payments and grow
      ...
      {feedback.map((card)=>
        <FeedbackCard key={card.content.id} {...card}/>
        )}
      </div>
      <div >
